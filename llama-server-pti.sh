...
#
# Point your editor at http://localhost:8080/v1 (same as llama-server) and
# SET TEMPERATURE TO 0 — verification is greedy; temp > 0 requests fall back
# to plain decode (logged per request on this console).
#
